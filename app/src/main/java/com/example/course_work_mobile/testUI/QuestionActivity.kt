...
import com.example.course_work_mobile.data.Question
import com.example.course_work_mobile.data.QuestionStorage
...
class QuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mTest = intent.getStringExtra(Constants.TEST)

        mQuestionsList = mTest?.let { QuestionStorage.getQuestions(it) }
    ...
    private fun setQuestion() {
        ...
        tv_progress.text = "$mCurrentPosition" + "/" + mQuestionsList!!.size.toString()
